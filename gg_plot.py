...
class ggPlot(QMainWindow):
    def __init__(self, serialhander : SerialHandler):
        ...
        self.plot_widget.setLabel("left",  '<span style="color: white; font-size: 18px">Y Acceleration (mG) </span>')
        self.plot_widget.setLabel("bottom",  '<span style="color: white; font-size: 18px">X Acceleration (mG) </span>')
